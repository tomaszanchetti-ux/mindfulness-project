...
**Profundidad:** objetivo **12 cartas por pilar** (72 totales), repartidas en sus
acciones viables. El motor del día (M2) no repite **ni carta ni concepto** en una
ventana de 7 días y balancea la acción (que no caigan varios días seguidos de la
misma).
...
| 3 | Biblioteca de cartas | 🟡 triage WS22: remap calma · acción inicial para ex "escribir" · sentido ~12 · vínculos 9→12 |
| 4 | Seed para la DB + motor | 🟡 re-seed + migración tras el triage (canon §Transición) |
