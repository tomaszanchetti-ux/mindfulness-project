...
| **D2 · Temporada 1** | 6 volúmenes, uno por pilar, **todos desde cero** (el vol. 1 de la WS26 es un boceto). Orden por el chiste más claro. Guiones en `Flipbook/guiones/`, descripciones, comentario fijado y hashtags. **Una WS por historieta:** guion → elementos puntuales de ese volumen con detalle → render → revisión de Tomás. Fondos y props simples; Teo, Pipo y el elemento clave, bien bajados. | 🟢 **1 de 6 · WS35** (08/09): **Vol. 1 · Vínculos, "LA MIRADA DE LOS OTROS"** — guion en papel + YAML + video de 30,7 s, con la familia y el Teo Spiderman dibujados y los globos abajo. Siguen 5 volúmenes, uno por WS. |
